<?php /* Smarty version Smarty-3.1.7, created on 2017-11-21 07:05:36
         compiled from "/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/ExtensionStore/Detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13733535425a13d0402504d6-27686022%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ac2d315b478176c3c5688e6fe71a70cf682e3fa' => 
    array (
      0 => '/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/ExtensionStore/Detail.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13733535425a13d0402504d6-27686022',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a13d040481c8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a13d040481c8')) {function content_5a13d040481c8($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/usr/ictcore/wwwroot/vtigercrm/libraries/Smarty/libs/plugins/modifier.replace.php';
?>
...
" class="rating" data-readonly="true"></span><div>out of 5</div><div>(<?php echo count($_smarty_tpl->tpl_vars['CUSTOMER_REVIEWS']->value);?>
 Reviews)</div></div></div><?php if (($_smarty_tpl->tpl_vars['REGISTRATION_STATUS']->value)&&($_smarty_tpl->tpl_vars['PASSWORD_STATUS']->value)){?><div class="col-sm-6 col-xs-6"><div class="pull-right"><?php if ($_smarty_tpl->tpl_vars['EXTENSION_DETAIL']->value->isInstalledByExtnStore()){?><button type="button" class="writeReview margin0px pull-right <?php if ($_smarty_tpl->tpl_vars['MODULE_ACTION']->value!='Installed'){?> hide<?php }?>"><?php echo vtranslate('LBL_WRITE_A_REVIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button><?php }else{ ?><span class="alert alert-error"><?php echo vtranslate('LBL_REVIEW_RESTRICTED',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><?php }?></div></div><?php }?></div><hr><div class="scrollableTab"><div class="customerReviewContainer" style=""><?php  $_smarty_tpl->tpl_vars['CUSTOMER_REVIEW'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['CUSTOMER_REVIEW']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
