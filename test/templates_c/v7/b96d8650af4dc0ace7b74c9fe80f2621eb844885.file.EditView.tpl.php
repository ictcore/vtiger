<?php /* Smarty version Smarty-3.1.7, created on 2017-11-21 09:19:12
         compiled from "/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/CustomView/EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13260223225a13ef901a95d4-10230604%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b96d8650af4dc0ace7b74c9fe80f2621eb844885' => 
    array (
      0 => '/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/CustomView/EditView.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13260223225a13ef901a95d4-10230604',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a13ef903f2bc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a13ef903f2bc')) {function content_5a13ef903f2bc($_smarty_tpl) {?>

<?php $_smarty_tpl->tpl_vars['SELECTED_FIELDS'] = new Smarty_variable($_smarty_tpl->tpl_vars['CUSTOMVIEW_MODEL']->value->getSelectedFields(), null, 0);?><div id="filterContainer"><form id="CustomView"><div class="modal-content"><div class="overlayHeader"><?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value){?><?php ob_start();?><?php echo vtranslate('LBL_EDIT_CUSTOM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</div><div class="modal-body"><div class="customview-content row"><input type=hidden name="record" id="record" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
...
&nbsp;<span class="redColor">*</span> </label><div class="row"><div class="col-lg-5"><input class="form-control" type="text" id="viewname" name="viewname" value="<?php echo $_smarty_tpl->tpl_vars['CUSTOMVIEW_MODEL']->value->get('viewname');?>
" data-rule-required="true" data-record-id="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
" data-rule-maxsize="100" data-rule-check-filter-duplicate='<?php echo Vtiger_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['CUSTOM_VIEWS_LIST']->value));?>
'></div><div class="col-lg-5"><label class="checkbox-inline"><input type="checkbox" name="setdefault" value="1" <?php if ($_smarty_tpl->tpl_vars['CUSTOMVIEW_MODEL']->value->isDefault()){?> checked="checked"<?php }?>> &nbsp;&nbsp;<?php echo vtranslate('LBL_SET_AS_DEFAULT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
' /></div><div class="col-lg-2"></div></div><div><label class="filterHeaders"><?php echo vtranslate('LBL_CHOOSE_FILTER_CONDITIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</label></div><select id="memberList" class="col-lg-7 select2 members op0<?php if ($_smarty_tpl->tpl_vars['LIST_SHARED']->value){?> fadeInx<?php }?>" multiple="true" name="members[]" data-placeholder="<?php echo vtranslate('LBL_ADD_USERS_ROLES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"/><div class='clearfix modal-footer-overwrite-style'><div class="row clearfix"><div class=' textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-success saveButton' id="customViewSubmit"><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
