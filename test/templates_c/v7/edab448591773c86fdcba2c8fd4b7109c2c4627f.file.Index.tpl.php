<?php /* Smarty version Smarty-3.1.7, created on 2017-11-21 09:10:53
         compiled from "/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/CustomerPortal/Index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11336719425a13ed9dcbb413-63438896%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'edab448591773c86fdcba2c8fd4b7109c2c4627f' => 
    array (
      0 => '/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/CustomerPortal/Index.tpl',
      1 => 1511246247,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11336719425a13ed9dcbb413-63438896',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a13ed9de0959',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a13ed9de0959')) {function content_5a13ed9de0959($_smarty_tpl) {?>

<div class="listViewPageDiv" id="listViewContent"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><br><br><form id="customerPortalForm" name="customerPortalForm" action="index.php" method="POST" class="form-horizontal"><input type="hidden" name="portalModulesInfo" value="" /><div class="col-sm-12 col-xs-12 input-group"><div class="form-group"><label for="privileges" class="col-sm-4 control-label fieldLabel"><span><?php echo vtranslate('LBL_PRIVILEGES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></label><div class="fieldValue col-lg-3 col-md-3 col-sm-3 input-group"><select name="privileges" class="select2 inputElement"><?php  $_smarty_tpl->tpl_vars['USER_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['USER_MODEL']->_loop = false;
...
</option><?php } ?></select><div class="input-group-addon input-select-addon"><a href="#" rel="tooltip" title="<?php echo vtranslate('LBL_PREVILEGES_MESSAGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"><i class="fa fa-info-circle"></i></a></div></div></div></div><div class="col-sm-12 col-xs-12 input-group"><div class="form-group"><label for="defaultAssignee" class="col-sm-4 control-label fieldLabel"><span><?php echo vtranslate('LBL_DEFAULT_ASSIGNEE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" class="help-inline" style="width: 300px;"><?php echo $_smarty_tpl->tpl_vars['PORTAL_URL']->value;?>
...
</h4><hr class="hrHeader"><input type="hidden" name="defaultCharts" value='<?php echo Vtiger_Functions::jsonEncode($_smarty_tpl->tpl_vars['CHARTS']->value,true);?>
'/><input type="hidden" name="defaultWidgets" value='<?php echo Vtiger_Functions::jsonEncode($_smarty_tpl->tpl_vars['WIDGETS']->value,true);?>
