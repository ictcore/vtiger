<?php /* Smarty version Smarty-3.1.7, created on 2017-11-21 09:16:32
         compiled from "/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Workflows/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14082446615a13eef082e553-70680437%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aab36ad6587411bfd8ea87afd837ee1a8443b6ea' => 
    array (
      0 => '/usr/ictcore/wwwroot/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Workflows/ListViewContents.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14082446615a13eef082e553-70680437',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a13eef09f9d9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a13eef09f9d9')) {function content_5a13eef09f9d9($_smarty_tpl) {?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["MODULE_ICON_NAME"] = new Smarty_variable($_tmp1, null, 0);?><?php if ($_smarty_tpl->tpl_vars['MODULE_ICON_NAME']->value=='events'){?><?php $_smarty_tpl->tpl_vars["MODULE_ICON_NAME"] = new Smarty_variable("calendar", null, 0);?><?php }?><i class="vicon-<?php echo $_smarty_tpl->tpl_vars['MODULE_ICON_NAME']->value;?>
" title='<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('module_name');?>
'>&nbsp;</i></td><?php }else{ ?><?php }?><?php } ?><td class="listViewEntryValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
" width="<?php echo $_smarty_tpl->tpl_vars['WIDTH']->value;?>
