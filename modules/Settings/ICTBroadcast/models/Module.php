...
class Settings_ICTBroadcast_Module_Model extends Settings_Vtiger_Module_Model{
    ...
    public function getModule($raw=true) {
		$moduleName = Settings_ICTBroadcast_Module_Model::getModuleName();
		if(!$raw) {
			$parentModule = Settings_ICTBroadcast_Module_Model::getParentName();
