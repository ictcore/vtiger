...
class Settings_ICTBroadcast_Gateway_Action extends Settings_Vtiger_IndexAjax_View{
    ...
    public function getSecretKey(Vtiger_Request $request) {
        $serverModel = ICTBroadcast_Server_Model::getInstance();
        ...
        if($vtigersecretkey) {
            ...
            $vtigersecretkey = ICTBroadcast_Server_Model::generateVtigerSecretKey();
            $response->setResult($vtigersecretkey);
        }
        $response->emit();
    }
