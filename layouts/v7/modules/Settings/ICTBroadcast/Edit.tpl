...
{strip}
	<div class="widget_header col-lg-12">
		<h4>{vtranslate('ICTBroadcast', $QUALIFIED_MODULE)}</h4>
		<hr>
	</div>
	<div class="container-fluid">
		...
		<form id="MyModal" class="form-horizontal" data-detail-url="{$MODULE_MODEL->getDetailViewUrl()}">
			...
			<input type="hidden" name="id" value="ICTBroadcast">
			<div class="blockData">
				<table class="table detailview-table no-border">
					<tbody>
						{assign var=FIELDS value=ICTBroadcast_ICTBroadcast_Connector::getSettingsParameters()}
