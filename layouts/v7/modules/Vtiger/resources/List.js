            ...
            jQuery('#massSave1').vtValidate({
                ...
                submitHandler: function (form) {
                    ...
                    app.request.post(params).then(function (err, data) {
                        app.helper.hideProgress();
                        app.helper.hideModal();
                        //alert(jQuery(form).find('[name="module"]').val());
                        if (jQuery(form).find('[name="module"]').val() == 'ICTBroadcast') {
                         // alert('hello');
                          ...
                          //    alert('bye');
                             ...
                             // var g_id = JSON.stringify(data.statusdetails.group_id);
                                        //   var c_name = JSON.stringify(data.statusdetails.campaign_type);
